...
Write-Host 
write-host -ForegroundColor Gray -backgroundcolor $backgroundcolor "Attack Surface Reduction Rules`n"
Write-Host 
write-host -foregroundcolor $warningmessagecolor "====================================== ASR Summary ======================================`n"
...
Write-Host 
write-host -foregroundcolor $warningmessagecolor "====================================== ASR Rules ======================================`n"
Write-Host 
...
Write-Host 
write-host -foregroundcolor $warningmessagecolor "====================================== ASR Exclusions ======================================`n"
Write-Host 
